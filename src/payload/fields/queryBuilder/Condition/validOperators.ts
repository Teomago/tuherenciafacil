...
type ValueType = 'any' | 'string' | 'boolean' | 'object'

type OperatorValueTypes = Record<string, ValueType>

export const getOperatorValueTypes = (fieldType: FieldTypes): OperatorValueTypes => {
  return {
    all: 'any',
    contains: 'string',
    equals: 'any',
     ...
     * // In our case it can be string too, so we should handle conversion right away
