...
const ColorPicker: React.FC<TextFieldClientProps & ColorPickerProps> = ({
	...
	const fieldWidth = field.admin?.width
	...
	return (
		<div
			className="field-type text color-picker-field"
			style={fieldWidth ? { '--field-width': fieldWidth } as React.CSSProperties : undefined}
		>
			<FieldLabel
				label={field.label}
