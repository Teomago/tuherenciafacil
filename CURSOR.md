...
**Repeat `mine .`:** **`Files processed: 0`** and **“skipped (already filed): N”** means nothing on disk changed since the last index — **expected**, not broken. Run **`mine .`** again after real file changes or a palace reset.
